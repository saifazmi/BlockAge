...
public class OptionsMenu implements Menu {
    public static Button yesButtonH, yesButtonS, noButtonH, noButtonS, yesButtonB, noButtonB, backButton = null;
    ...
    public void declareElements() {
        ...
        onImageHovered = new Image(SEPARATOR + "sprites" + SEPARATOR + "On.png", 395, 55, true, true);

        offImage = new Image(SEPARATOR + "sprites" + SEPARATOR + "Off.png", 395, 55, true, true);
        offImageHovered = new Image(SEPARATOR + "sprites" + SEPARATOR + "Off.png", 395, 55, true, true);
    ...
    public void initialiseScene() {
        ...
        optionsMenuPane.getChildren().addAll(hintsLabel, soundLabel, blockadeLabel, noButtonH, noButtonS, noButtonB, backButton);
