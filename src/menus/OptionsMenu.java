...
public class OptionsMenu implements Menu {
	...
	public void declareElements() {
		...
		onImage = new Image(getClass().getResourceAsStream("images/on_button.png"));
		onImageHovered = new Image(getClass().getResourceAsStream("images/on_button_hovered.png"));
		
		offImage = new Image(getClass().getResourceAsStream("images/off_button.png"));
		offImageHovered = new Image(getClass().getResourceAsStream("images/off_button_hovered.png"));
		
		hintsImage = new Image(getClass().getResourceAsStream("images/hints_label.png"));
		soundImage = new Image(getClass().getResourceAsStream("images/sound_label.png"));
		
		backImage = new Image(getClass().getResourceAsStream("images/back_button.png"));
		backImageHovered = new Image(getClass().getResourceAsStream("images/back_button.hovered.png"));
	}
	/**
